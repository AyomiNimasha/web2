...
import { FooterBarCard } from "./FooterBarCard";
    ...
    <div className="h-96 ">
      <div className="flex gap-24 text-xs font-serif font-semibold tracking-wide leading-loose pb-10 bg-teal-100 justify-center">
        <div className="  w-[400px] p-6">
          ...
          <div>
            Sri Lanka's No 01 Women's Clothing Store. You can never go wrong
            with us! Explore the most stunning designs, sure to grab anyone's
